...
本節では，状態遷移図から自動生成されたファームウェアを用いて実装した無線通信プロトコルについて述べる。本プロトコルは，園田ら\cite{sonoda}によるCSMA/TDMAベースのプロトコルを参考として設計したものであり，TDMAによるスロット分割を基本構造としつつ，各端末が自律的に送信スロットを決定する点に特徴を持つ。
